...
def define_args():
    ...
    parser.add_argument('--pretrain_input_file', type=str, default="/data_train/pretrain/*")
    ...
    parser.add_argument('--qrels', type=str, default="/data_train/qrels.train.remains.tsv")
    parser.add_argument('--top1000', type=str, default="/data_train/run.msmarco-passage.train.remains.tsv")
    parser.add_argument('--dev_top1000', type=str, default="/data_train/run.msmarco-passage.train.remains.tsv")
    parser.add_argument('--collection', type=str, default="/data_train/marco/collection.remains.tsv")
    parser.add_argument('--query', type=str, default="/data_train/train.query.remains.txt")
    parser.add_argument('--dev_query', type=str, default="/data_train/train.query.remains.txt")
    parser.add_argument('--generated_query', type=str, default="/data_train/train.query.remains.txt")
